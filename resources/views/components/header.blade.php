<div class="pre-header d-none d-lg-block">
      ...
      <div class="site-header">
         <img src="/images/2026/TESSHeaderBanner.jpg" class="img-fluid"> 
      </div>
         ...
         <div class="collapse navbar-collapse navbar" id="navbarSupportedContent">
            <ul class="">
               <li><a class="nav-link scrollto active ps-0" href="/">HOME</a></li>
                ...
                <li><a href="/tess-brochure" target="_blank">Brochure</a></li>
                     <li><a href="/about-organizer" target="_blank">About Organizer</a></li> 
					  ...
					  <li><a href="/post-event-report" target="_blank">Post Event Reports</a></li>
                  </ul>
               </li>
			     <li class="dropdown">
               ...
               <li class="dropdown">
                  ...
                  <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                     <li><a href="/partnership-opportunity-information" target="_blank">Partnership Opportunities</a></li>
                      <li><a href="/key-partners" target="_blank">Key Partners</a></li>
                      ...
                      <li><a href="/media-and-marketing-partner" target="_blank">Media and Marketing Partners</a></li>
			 ...
			 <li class="dropdown">
			   ...
			   <li><a class="nav-link scrollto" href="/isuw-2026-presentations">PRESENTATIONS</a></li>
				   <li class="dropdown">
                  <a href="#" class=" " data-bs-toggle="dropdown"><span>MEDIA</span> <i class="fa fa-chevron-down"></i></a>
                  <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                     <li><a href="/photo-gallery" target="_blank">Photos</a></li>
               ...
               <li><a class="getstarted scrollto" href="https://energysingularitysummit.com/conference-agenda-and-program" target="_blank">TESS AGENDA</a></li>
