...
class BannerController extends Controller
{
    ...
    public function uploadSpeaker(Request $request)
    {
        ...
        $banners = DB::table('speakers2026')->insert(['imageUrl'=>$imageurl,'isActive'=>'1','imageAlt'=>$request->altText,'name'=>$request->name,'description'=>$request->desc,'company'=>$request->company]);
        return "Sucessfully updated";
    }
