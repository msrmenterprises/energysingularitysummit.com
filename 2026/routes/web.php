...
// });
 ...
 Route::get('/raid-olympiad-removed', function () {
     return view('/components/raid-olympiad-deleted');
});
...
Route::post('/presentation2023', [LoginController::class,'presentationauthenticate2023'])->name('loginpresentation2023');
Route::get('/presentation2024',[LoginController::class,'presentation2024']);
Route::post('/presentation2024', [LoginController::class,'presentationauthenticate2024'])->name('loginpresentation2024');
Route::get('/presentation2026',[LoginController::class,'presentation2026']);
Route::post('/presentation2026', [LoginController::class,'presentationauthenticate2026'])->name('loginpresentation2026');
...
Route::post('delete-banner-permanent', [BannerController::class,'deleteBannerPermanent']);
